...
//       <h1 className="text-3xl font-semibold">Staff Augmentation</h1>
//     </main>
//   );
// }
            ...
            <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-8 ">
              <div className="max-w-2xl px-0 p-4 md:py-8 md:px-0 ">
                ...
                <p className="mt-3 max-w-xl text-base leading-relaxed text-white/70 sm:text-xl">
                  Skilled IT professionals to extend your team capabilities and
                ...
                <ul className="text-base font-inter font-normal flex flex-col gap-3 list-disc list-inside  leading-relaxed text-white/70 sm:text-lg mb-3">
                  <li>Dedicated Development Teams</li>
                  <li>Project-based Resources</li>
